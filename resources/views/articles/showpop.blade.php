    ...
    <div class="container" id="backgrey">
      ...
      <div class="row pt-2">
        ...
        <div class="col-lg-4 d-none d-lg-block">
          ...
          <h4 class="mb-0 popart-header">More Articles</h4>
          <ul class="list-group list-group-flush dropdown">
            @foreach ($top_headlines as $top_art)
              <a href=@php
                          if ($top_art->sport === 'Pop Culture') {
                              echo '/pop-culture/' . $top_art->slug;
                          } else {
                              echo '/articles/' . $top_art->slug;
                          }
                        @endphp 
                    class="list-group-item list-group-item-action p-1" id="article-blend">
          ...
          <h4 class="mb-0 popart-header">Latest in {{$article->sport}}</h4>
          <ul class="list-group list-group-flush dropdown">
            @foreach ($sports as $sport_article)
              <a href="/pop-culture/{{$sport_article->slug}}"
        ...
        <div class="col-lg-8 mb-3">
          <h4 class="w-100 text-center popart-header">More from {{$article->author}}</h4>
          <div class="row">
              ...
              <div class="col-md-6 col-12 mb-3">
                <div class="card" id="card-hover">
                  ...
                  <div class="card-body m-0 p-0 pl-2 pr-3 pb-0">
                    ...
                    <a href=@php
                                if ($other->sport === 'Pop Culture') {
                                    echo '/pop-culture/' . $other->slug;
                                } else {
                                    echo '/articles/' . $other->slug;
                                }
                              @endphp 
                          class="stretched-link"></a>
                  </div>
                  <div class="card-footer p-1" id="readMorePink">
