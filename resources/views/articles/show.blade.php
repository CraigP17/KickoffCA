  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-10" style="background-color: #E3E3E3;padding-left:5vw;padding-right:4vw;">
        ...
        <h5 class="author">  @isset($author) <img src="/storage/Images/Authors/{{$author->profile_pic}}" alt="{{$author->name}}" class="art-author-img">
          <a href="/authors/{{$author->slug}}">{{$author->name}}</a> @endisset
